...
GreenMetrics adopts the [Contributor Covenant v2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/)
as its code of conduct, with the modifications and contact details below.
...
The project maintainer (Renan Augusto Macena) is responsible for
clarifying and enforcing our standards of acceptable behaviour and will
take appropriate and fair corrective action in response to any behaviour
...
repository, issues, pull requests, discussions, and any official
project channels), and also applies when an individual is officially
...
The maintainer will follow the **Contributor Covenant Enforcement
Ladder** (Correction → Warning → Temporary Ban → Permanent Ban) as set
out in the [Contributor Covenant v2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/).
