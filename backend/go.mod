...
require (
	...
	github.com/go-playground/validator/v10 v10.30.2 // ADR-0012
	github.com/goburrow/modbus v0.1.0
	github.com/gofiber/contrib/otelfiber v1.0.10
	github.com/gofiber/fiber/v2 v2.52.13
	github.com/golang-jwt/jwt/v5 v5.3.1
	github.com/google/uuid v1.6.0
	github.com/hibiken/asynq v0.26.0 // ADR-0014
	github.com/jackc/pgx/v5 v5.9.2
	github.com/joho/godotenv v1.5.1
	github.com/pressly/goose/v3 v3.27.1 // ADR-0005
	github.com/prometheus/client_golang v1.23.2

	// Sprint S4 additions (run `go mod tidy` to materialise versions).
	github.com/sony/gobreaker/v2 v2.4.0 // ADR-0009
